...
## Start with a fresh Ubuntu 24.04 install. I use lxc containers on Proxmox. VM or bare metal should be similar.
...
My testing shows routing and lan-discovery need to be enabled:
